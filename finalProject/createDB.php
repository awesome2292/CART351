...
try
{
   ...
   $theQuery = 'CREATE TABLE userInfo (smID INTEGER PRIMARY KEY NOT NULL, username TEXT, xCoord INTEGER, yCoord INTEGER, numClicks INTEGER, nodeSize INTEGER, name TEXT, favColor TEXT)';
   $ok = $db ->exec($theQuery);
